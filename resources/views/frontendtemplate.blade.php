  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link font-weight-bold" href="{{route('homepage')}}">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link font-weight-bold" href="{{route('aboutpage')}}">About</a>
      </li>
      <li class="nav-item">
        <a class="nav-link font-weight-bold" href="{{route('contactpage')}}">Contact</a>
      </li>
      ...
      @else
      <li class="nav-item">
        <a class="nav-link font-weight-bold" href="{{route('loginpage')}}">Login</a>
      </li>
      @endif
    </ul>
