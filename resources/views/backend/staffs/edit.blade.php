...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
    	<div class="row">
    		<div class="col">
      		<h1 class="h3 mb-0 text-gray-800">Staff Edit Form</h1>
    		</div>
    	</div>
    </div>
      	...
      	<div class="col-md-12">
      		<form action="{{route('staffs.update',$staff->id)}}" method="post" enctype="multipart/form-data">
			      ...
			      <div class="form-group row {{ $errors->has('address') ? 'has-error' : '' }}">
			        ...
			        <div class="col-sm-5">
			          <textarea id="inputAddress" class="form-control" name="address">
			          	{{$staff->address}}
			          </textarea>
			      ...
			      <div class="form-group row {{ $errors->has('phone') ? 'has-error' : '' }}">
			        ...
			        <div class="col-sm-5">
			          <input type="text" class="form-control" id="inputPhone" name="phone" value="{{$staff->phone}}">
			       ...
			       <div class="form-group row {{ $errors->has('photo') ? 'has-error' : '' }}">
			        ...
			        <div class="col-sm-5">
			          ...
			          <img src="{{asset($staff->photo)}}" class="img-fluid w-25">
