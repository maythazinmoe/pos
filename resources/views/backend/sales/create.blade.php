...
@section('content')
      	...
      	<div class="col-md-12">
      		{{-- <form action="{{route('sales.store')}}" method="post" enctype="multipart/form-data">
			      ...
			      <div class="form-group row {{ $errors->has('status') ? 'has-error' : '' }}">
			        ...
			        </div> <input type="button" class="btn btn-outline-success search float-right" value="Search">
			      </div>
 ...
 <button class="btn btn-secondary btn-block mainfullbtncolor checkoutbtn w-25 float-right"> 
                  Check Out 
