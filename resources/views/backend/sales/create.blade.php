      	...
      	<div class="col-md-12">
      		<form action="{{route('sales.update',$sale->id)}}" method="post" enctype="multipart/form-data">
			      ...
			      <div class="form-group row">
			        <label for="inputCodeno" class="col-sm-2 col-form-label">Product_Name</label>
			        <div class="col-sm-5">
			          <input type="text" class="form-control @error('title') is-invalid @enderror" id="inputCodeno" name="codeno" value="{{$sale->name}}" readonly="readonly">
			      ...
			      <div class="form-group row {{ $errors->has('photo') ? 'has-error' : '' }}">
			        ...
			        <div class="col-sm-5">
			          ...
			          <img src="{{asset($sale->photo)}}" class="img-fluid w-25">

			          <input type="hidden" name="oldphoto" value="{{$sale->photo}}">
			      ...
			      <div class="form-group row {{ $errors->has('description') ? 'has-error' : '' }}">
			        ...
			        <div class="col-sm-5">
			          <textarea id="inputDescription" class="form-control" name="description">{{$sale->description}}</textarea>
